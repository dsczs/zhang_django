...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'COREPYTHONPATH': ':',
 'COVERAGE_INFO': '/usr/local/zhang_django/src/Python-3.6.1/coverage.info',
 'COVERAGE_REPORT': '/usr/local/zhang_django/src/Python-3.6.1/lcov-report',
 ...
 'abs_builddir': '/usr/local/zhang_django/src/Python-3.6.1',
 'abs_srcdir': '/usr/local/zhang_django/src/Python-3.6.1',
